...
namespace SchoolManagement
{
    public partial class BookEntry : System.Web.UI.Page
    {
        ...
        {
            if(!Validator.IsValidBDMobileNo(txtBrandName.Text))
            {
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (affRow > 0)
            {
                ActivityLog.SaveProcess(ActionType.Update, "btnUpdate_Click", "UpdateBrand", affRow.ToString());
        ...
        protected void gvBrand_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                else if (e.CommandName == "RemoveRow")
                {
                    ...
                    if (affRow > 0)
                    {
                        ActivityLog.SaveProcess(ActionType.Delete, "btnUpdate_Click", "UpdateBrand", affRow.ToString());
