<%@ Page Title="Waiver Approval | SMS" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="WaiverApproval.aspx.cs" Inherits="SchoolManagement.WaiverApproval" %>
                    ...
                    <div runat="server" id="divEntry">
                        ...
                        <div class="card-body style-default-bright">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-4">
                                    <asp:TextBox runat="server" ID="txtRollNo" placeholder="Roll Number" Enabled="false" CssClass="TextBoxStyle"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-sm-12">
                            ...
                            <div class="col-sm-12" style="margin-top: 15px">
                                ...
                                <div class="col-sm-4">
                                    <asp:TextBox runat="server" ID="txtAmount" placeholder="Waiver Amount" CssClass="TextBoxStyle" Style="text-align: right"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="col-sm-2">
                                ...
                                <div class="col-sm-10">
                                    <asp:TextBox ID="txtRemarks" runat="server" placeholder="Remarks" TextMode="MultiLine" Rows="2" CssClass="TextBoxStyle"></asp:TextBox>
                                </div>
                            </div>
