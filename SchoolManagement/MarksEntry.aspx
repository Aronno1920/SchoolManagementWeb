<%@ Page Title="Exam Marks Entry | SMS" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="MarksEntry.aspx.cs" Inherits="SchoolManagement.MarksEntry" %>
                    ...
                    <div runat="server" id="divEntry">
                        ...
                        <div class="card-body style-default-bright">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-9">
                                    <asp:DropDownList ID="DropDownList3" runat="server" CssClass="DropDownListStyle"></asp:DropDownList>
                                </div>
                            </div>
