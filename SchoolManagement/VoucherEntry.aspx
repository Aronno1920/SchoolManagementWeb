<%@ Page Title="Voucher Entry | SMS" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="VoucherEntry.aspx.cs" Inherits="SchoolManagement.VoucherEntry" %>
            ...
            <div class="col-sm-12">
                <div class="col-lg-8">
                    <div runat="server" id="divMasterPanel">
                        <div class="card-head">
                            <header><i style="padding-left: 3px; padding-right: 6px" class="fa fa-plus-circle"></i>Voucher Entry - Master Information</header>
                        </div>
                    ...
                    <div runat="server" id="divButtonPanel">
                        <div class="card-body style-default-bright">
                            <div class="col-sm-12" style="padding: 5px; text-align: center;">
                                <asp:Button runat="server" ID="btnSave" Text="Save" OnClick="btnSave_Click" CssClass="btn btn-raised btn-accent" />
                                <asp:Button runat="server" ID="btnSubmit" Text="Submit" OnClick="btnSubmit_Click" class="btn btn-raised btn-primary" />
                                <asp:Button runat="server" ID="btnDelete" Text="Delete" OnClick="btnDelete_Click" class="btn btn-raised btn-danger" />
                ...
                <div class="col-sm-4">
                    <div runat="server" id="divVoucherList">
                        <div class="card-head">
                            <header><i style="padding-left: 3px; padding-right: 6px" class="fa fa-plus-circle"></i>Draft Voucher - Information</header>
                        </div>
                        <div class="card-body style-default-bright">
