<%@ Page Title="Notice Entry | SMS" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="NoticeEntry.aspx.cs" Inherits="SchoolManagement.NoticeEntry" %>
                    ...
                    <div runat="server" id="divEntry">
                        ...
                        <div class="card-body style-default-bright">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-9">
                                    <asp:TextBox ID="txtBrandName" runat="server" TextMode="MultiLine" Rows="5" CssClass="TextBoxStyle"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="col-sm-3">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-9">
                                    <asp:FileUpload ID="TextBox3" runat="server" CssClass="TextBoxStyle"></asp:FileUpload>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9">
                                    <asp:CheckBox ID="cbShowWebsite" runat="server" CssClass="checkbox" />
                                </div>
                            </div>
