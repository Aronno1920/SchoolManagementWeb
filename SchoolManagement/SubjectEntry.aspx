<%@ Page Title="Subject Information | SMS" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="SubjectEntry.aspx.cs" Inherits="SchoolManagement.SubjectEntry" %>
            ...
            <div class="col-sm-12">
                <div class="col-lg-6">
                    <div runat="server" id="divEntry">
                        <div class="card-head">
                            <header><i style="padding-left: 3px; padding-right: 6px" class="fa fa-plus-circle"></i>Subject Entry</header>
                        </div>
                        <div class="card-body style-default-bright">
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <asp:HiddenField runat="server" ID="hdSubjectId" />
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9">
                                    <asp:TextBox ID="txtSubjectCode" runat="server" CssClass="TextBoxStyle"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9">
                                    <asp:TextBox ID="txtSubjectName" runat="server" CssClass="TextBoxStyle"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9">
                                    <asp:TextBox ID="txtSubjectNameBangla" runat="server" CssClass="TextBoxStyle"></asp:TextBox>
                                </div>
                            </div>
                ...
                <div class="col-lg-6">
                    <div runat="server" id="divDetails">
                        <div class="card-head">
                            <header><i style="padding-left: 3px; padding-right: 6px" class="fa fa-book"></i>Subject Details (<asp:Label runat="server" ID="lblRecordCount">0</asp:Label>)</header>
                        </div>
                        <div class="card-body style-default-bright">
                            ...
                            <div class="col-sm-12">
                                <asp:GridView ID="gvSubject" runat="server" OnRowCommand="gvSubject_RowCommand" OnPageIndexChanging="gvSubject_OnPageIndexChanging" Width="100%" Class="NewGridDesingBody" AllowPaging="true" PageSize="15" RowStyle-Wrap="false"
                                    EmptyDataText="No data found for selected criteria." ShowHeaderWhenEmpty="True" AutoGenerateColumns="False">
                                    <Columns>
                                        <asp:BoundField DataField="SubjectId" HeaderText="Subject Id" ItemStyle-CssClass="HideGridColumn" HeaderStyle-CssClass="HideGridColumn" />
                                        <asp:BoundField DataField="ClassName" HeaderText="Class Name" />
                                        <asp:BoundField DataField="SubjectCode" HeaderText="Subject Code" />
                                        <asp:BoundField DataField="SubjectName" HeaderText="Subject Name (EN)" />
                                        <asp:BoundField DataField="SubjectNameBangla" HeaderText="Subject Name (BN)" />
