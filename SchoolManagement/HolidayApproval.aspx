<%@ Page Title="Holiday Approval | SMS" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="HolidayApproval.aspx.cs" Inherits="SchoolManagement.HolidayApproval" %>
            ...
            <div class="col-sm-12">
                <div class="col-lg-6">
                    <div runat="server" id="divEntry">
                        <div class="card-head">
                            <header><i style="padding-left: 3px; padding-right: 6px" class="fa fa-plus-circle"></i>Holiday Approval</header>
                        </div>
