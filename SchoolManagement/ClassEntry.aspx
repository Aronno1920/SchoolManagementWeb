<%@ Page Title="Class Information | SMS" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ClassEntry.aspx.cs" Inherits="SchoolManagement.ClassEntry" %>
            ...
            <div class="col-sm-12">
                <div class="col-lg-6">
                    <div runat="server" id="divEntry">
                        <div class="card-head">
                            <header><i style="padding-left: 3px; padding-right: 6px" class="fa fa-plus-circle"></i>Class Entry</header>
                        </div>
                        <div class="card-body style-default-bright">
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-9">
                                    <asp:TextBox ID="txtClassName" runat="server" CssClass="TextBoxStyle"></asp:TextBox>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-9">
                                    <asp:TextBox ID="txtClassNameBangla" runat="server" CssClass="TextBoxStyle"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9">
                                    <asp:TextBox ID="txtClassAlias" runat="server" CssClass="TextBoxStyle"></asp:TextBox>
                                </div>
                            </div>
                ...
                <div class="col-lg-6">
                    <div runat="server" id="divDetails">
                        <div class="card-head">
                            <header><i style="padding-left: 3px; padding-right: 6px" class="fa fa-book"></i>Class Details (<asp:Label runat="server" ID="lblRecordCount">0</asp:Label>)</header>
                        </div>
                        <div class="card-body style-default-bright">
                            <div class="col-sm-12" style="margin-bottom: 10px; overflow: auto;">
                                <asp:GridView ID="gvClass" runat="server" OnRowCommand="gvClass_RowCommand" OnPageIndexChanging="gvClass_OnPageIndexChanging" Width="100%" Class="NewGridDesingBody" AllowPaging="true" PageSize="15" RowStyle-Wrap="false"
                                    EmptyDataText="No data found for selected criteria." ShowHeaderWhenEmpty="True" AutoGenerateColumns="False">
                                    <Columns>
                                        <asp:BoundField DataField="ClassId" HeaderText="Class ID" ItemStyle-CssClass="HideGridColumn" HeaderStyle-CssClass="HideGridColumn" />
                                        <asp:BoundField DataField="ClassName" HeaderText="Class Name" />
                                        <asp:BoundField DataField="ClassNameBangla" HeaderText="Class Name (BN)" />
                                        <asp:BoundField DataField="ClassNameAlias" HeaderText="Class Alias" />
