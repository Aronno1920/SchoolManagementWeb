<%@ Page Title="Candidate Photo Upload | SMS" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="CandidatePhotoUpload.aspx.cs" Inherits="SchoolManagement.CandidatePhotoUpload" %>
            ...
            <div class="col-sm-12">
                <div class="col-lg-6">
                    <div runat="server" id="divEntry">
                        <div class="card-head">
                            <header><i style="padding-left: 3px; padding-right: 6px" class="fa fa-plus-circle"></i>Upload Photo - Candidate Profile</header>
                        </div>
                        <div class="card-body style-default-bright">
                            <div class="col-sm-12">
                                <div class="col-sm-2">Code</div>
                                <div class="col-sm-4">
                                    <asp:TextBox runat="server" ID="txtCandidateCode" placeholder="Candidate Code" CssClass="TextBoxStyle" Enabled="false"></asp:TextBox>
                                </div>
                                <div class="col-sm-2">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-4">
                                    <asp:TextBox runat="server" ID="txtCandidateName" placeholder="Candidate Name" CssClass="TextBoxStyle" Enabled="false"></asp:TextBox>
                                </div>
                            ...
                            <div class="col-sm-12">
                                <div class="col-sm-2">F. Name</div>
                                <div class="col-sm-4">
                                    <asp:TextBox runat="server" ID="txtFatherName" placeholder="Father Name" CssClass="TextBoxStyle" Enabled="false"></asp:TextBox>
                                </div>
                                <div class="col-sm-2">M. Name</div>
                                <div class="col-sm-4">
                                    <asp:TextBox runat="server" ID="txtMotherName" placeholder="Mother Name" CssClass="TextBoxStyle" Enabled="false"></asp:TextBox>
                                </div>
                            </div>
                    ...
                    <div runat="server" id="divDetails">
                        ...
                        <div class="card-body style-default-bright">
                            ...
                            <div class="col-sm-12" style="overflow: auto;">
                                <asp:GridView ID="gvCandidate" runat="server" OnRowCommand="gvCandidate_RowCommand" Width="100%" Class="NewGridDesingBody" AllowPaging="true" PageSize="10" RowStyle-Wrap="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Action">
                                            ...
                                            <ItemTemplate>
                                                <asp:ImageButton runat="server" ID="ibtnEdit" CommandName="EditRow" ToolTip="Click For Edit" ImageUrl="~/img/edit.png" Width="25px" Height="25px" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
