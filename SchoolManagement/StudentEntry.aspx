<%@ Page Title="Student Entry | SMS" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="StudentEntry.aspx.cs" Inherits="SchoolManagement.StudentEntry" %>
            ...
            <div class="col-sm-12">
                ...
                <div class="col-sm-6">
                    ...
                    <div runat="server" id="divCurrentAcademic">
                        <div class="card-head">
                            <header><i style="padding-left: 3px; padding-right: 6px" class="fa fa-book"></i>Admission Informaton</header>
                        </div>
                        <div class="card-body style-default-bright">
                            <div class="col-sm-12">
                                <div class="col-sm-2">
                                ...
                                <div class="col-sm-4">
                                    <asp:DropDownList runat="server" ID="ddlSessionYear" CssClass="DropDownListStyle"></asp:DropDownList>
                                </div>
                            </div>
                            <div class="col-sm-12" style="margin-bottom: 10px">
                                ...
                                <div class="col-sm-4">
                                    <asp:TextBox runat="server" ID="txtNewRollNo" CssClass="TextBoxStyle" Style="text-align: right"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-sm-12">
                    ...
                    <div runat="server" id="divProfilePhoto" style="margin-top: 20px;">
                        <div class="card-head">
                            <header><i style="padding-left: 3px; padding-right: 6px" class="fa fa-book"></i>Profile Photo</header>
                        </div>
                        <div class="card-body style-default-bright">
                            <div class="col-sm-12">
                                <div class="col-sm-2">
                                ...
                                <div class="col-sm-10">
                                    <asp:FileUpload ID="uProfilePhoto" runat="server" onchange="ImagePreview(this);" CssClass="TextBoxStyle" />
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="col-sm-2">
                                ...
                                <div class="col-sm-10">
                                    <asp:Image runat="server" ID="imgProfilePhoto" Style="height: 200px; width: 180px;" />
                    ...
                    <div runat="server" id="divButton">
                        <div class="card-body style-default-bright">
                            <div class="col-sm-12" style="padding: 5px; text-align: center;">
                                <asp:Button runat="server" ID="btnSave" Text="Save" OnClick="btnSave_OnClick" OnClientClick="return validate();" class="btn btn-raised btn-primary" />
