...
namespace CoreLibrary
{
    public class Cookie
    {
        ...
        public String LoginID
        {
            get
            {
                string cookieValue = GetCookie(CookieKey.LoginID.ToString());
        ...
        public String UserRole
        {
            get
            {
                string cookieValue = GetCookie(CookieKey.UserRole.ToString());
        ...
        public String ApplicationTheme
        {
            get
            {
                string cookieValue = GetCookie(CookieKey.ApplicationTheme.ToString());
    ...
    public enum CookieKey { UserID, LoginID, UserName, UserRole, Email, Mobile, ProfilePhoto, IsAdmin, ApplicationTheme, HomePage, ApplicationName, SchoolName};
}
