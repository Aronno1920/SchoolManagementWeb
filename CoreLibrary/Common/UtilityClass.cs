...
namespace CoreLibrary
{
    public static class UtilityClass
    {
        ...
        public static Boolean CheckValidation(String sDatabaseName)
        {
            Boolean isValid = false;
            if (!sDatabaseName.Equals("SchoolManagementSystem"))
            {
                DateTime dCurrentDate = DateTime.Now;
                DateTime dLicenseExpire = new DateTime(2021, 1, 1, 0, 0, 0);
                isValid = dCurrentDate <= dLicenseExpire;
            }
            else
            {
                isValid = true;
        ...
        public static String GetIPAddress(bool GetLan = false)
        {
            ...
            if (String.IsNullOrEmpty(visitorIPAddress) || visitorIPAddress.Trim() == "::1" || visitorIPAddress.Trim() == "127.0.0.1")
            {
                GetLan = true;
